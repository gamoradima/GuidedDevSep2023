	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_g5qld96_caption)#",
					"color": "primary",
					"disabled": false,
					"size": "medium",
			...
			{
				"operation": "insert",
				"name": "MenuItem_9jdl301",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_9jdl301_caption)#",
					"visible": true,
					"clicked": {
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_b4skfgl_caption)#",
					"visible": true,
					"clicked": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.LookupAttribute_xyh4hca;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.LookupAttribute_sruvbq5;
					var offerTypeId = "";
					if (offerTypeObject) {
