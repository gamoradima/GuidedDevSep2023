namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAverageRealtyPriceMethodsWrapper

	/// <exclude/>
	public class UsrCalculateAverageRealtyPriceMethodsWrapper : ProcessModel
	{

		public UsrCalculateAverageRealtyPriceMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			var esq = new EntitySchemaQuery(UserConnection.EntitySchemaManager, "UsrRealtyFRUI");
