define("UsrRealtyClassic1Page", ["ServiceHelper"], function(ServiceHelper) {
	return {
		...
		details: /**SCHEMA_DETAILS*/{
			...
			"UsrSchemab8d89dbbDetail8fe2b3c8": {
				"schemaName": "UsrSchemab8d89dbbDetail",
		...
		methods: {
			...
			getWebServiceResult: function(response, success) {
				...
				this.console.log("Total amount by typeId: " + response.GetTotalAmountByTypeIdResult);
			}
		},
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrNamee59b0a2d-c3f4-466f-a50a-24f2d7e796e4",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATe4de1f1f-0ad7-4756-b7bc-28ff43f0a01f",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT885f74ca-26e8-4f0d-ba2f-3a69d768c15d",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPe7dc6473-40d1-4c89-95bc-a4e07af6751f",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPd4889f87-fa61-4945-8a6e-4b715c71c31b",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "STRING3fdd0cef-4004-4dcc-89ef-c7db8f8d219e",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP69f2d2cc-67ed-4e26-ac19-e3d9ec485086",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "Tab0268b5a0TabLabel",
				"values": {
					"caption": {
						"bindTo": "Resources.Strings.Tab0268b5a0TabLabelTabCaption"
					},
					"items": [],
					"order": 0
				},
			...
			{
				"operation": "insert",
				"name": "UsrSchemab8d89dbbDetail8fe2b3c8",
				"values": {
					"itemType": 2,
					"markerValue": "added-detail"
				},
				"parentName": "Tab0268b5a0TabLabel",
				"propertyName": "items",
				"index": 0
			},
			{
